...
<head>
    <meta charset="utf-8">
    <title>Fashionable clothes</title>
                            ...
                            @auth
                                <ul>
                                    <li>
                                        ...
                                        <a href="{{ route('login') }}">{{ Auth::user()->name }}
                                        </a> /
                                            ...
                                            @auth
                                                @if (Auth::user()->utype == 'ADM')
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="{{ route('admin.categories') }}">Danh mục</a>
                                                        </li>
                                                        <li><a href="{{ route('admin.home.slider') }}">ManageSlider</a></li>
